...
class AliPayManager : NSObject {
    ...
    func payAlertController(_ sender: UIViewController,
        ...
        AlipaySDK.defaultService().payOrder(request, fromScheme:"com.qianxing.zuyu2.alipay",callback:nil)
    }
    ...
    func login(_ sender:UIViewController,withInfo:String,loginSuccess: @escaping (_ str:String) -> Void,loginFail:@escaping () -> Void){
        ...
        AlipaySDK.defaultService().auth_V2(withInfo:withInfo, fromScheme:"com.qianxing.zuyu2.alipay", callback:nil)
    }
    ///授权回调
